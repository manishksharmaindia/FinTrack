...
export function EmiTab() {
  const emiEntries = useFirestoreQuery<EmiEntry>('emiEntries') || [];
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative flex items-center">
                    ...
                    <input type="number" step="0.01" min={0} value={form.totalAmount || ''} onChange={e => f('totalAmount', parseFloat(e.target.value) || 0)}
                      style={{ paddingLeft: '42px' }}
                      className="w-full pr-4 py-2.5 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-secondary)] text-sm text-[var(--color-text-primary)] focus:outline-none focus:ring-2 focus:ring-primary-500/30" />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative flex items-center">
                    <IndianRupee size={16} className="absolute left-3.5 text-[var(--color-text-tertiary)]" />
                    <input type="number" step="0.01" min={0} value={form.emiAmount || ''} onChange={e => f('emiAmount', parseFloat(e.target.value) || 0)} required
                      style={{ paddingLeft: '42px' }}
                      className="w-full pr-4 py-2.5 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-secondary)] text-sm text-[var(--color-text-primary)] focus:outline-none focus:ring-2 focus:ring-primary-500/30" />
                  </div>
                </div>
